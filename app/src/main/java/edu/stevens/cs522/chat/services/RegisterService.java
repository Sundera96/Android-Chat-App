...
public class RegisterService extends Service {
    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
        ...
        PendingIntent pendingCancelIntent = PendingIntent.getForegroundService(this, 0, cancelIntent, PendingIntent.FLAG_IMMUTABLE);
        Notification.Action cancelAction = new Notification.Action.Builder(icon,getResources().getString(R.string.cancel), pendingCancelIntent).build();
            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        // DO NOT DISPLAY A TOAST (It's unsafe.  Why?)
                        notificationBuilder= createNotificationBuilder()
                                .setContentText(getText(R.string.register_canceled_notification_message))
                                .setTicker(getText(R.string.register_canceled_ticker_text));
